...
import Icon from '../Asssets/Gym.jpg'

const EachBodyPart = ({ item, setBodyPart, bodyPart }) => (
  <Stack
    type="button"
    alignItems="center"
    justifyContent="center"
    className="bodyPart-card"
    sx={bodyPart === item ? { borderTop: '4px solid #403234', background: '#fff', borderBottomLeftRadius: '20px',
